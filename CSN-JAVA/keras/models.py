...
from keras.layers import Concatenate, Dot, Embedding, Dropout, Lambda, Activation, Dense, GlobalMaxPooling1D, \
...
class JointEmbeddingModel:
    ...
    def build(self):
        ...
        # att_matrix=Activation("tanh")(att_matrix)
        ...
        # desc_weight=Activation("tanh")(att_matrix)
        # desc_weight=Bdot([desc_weight, sim_desc_dropout])
        att_matrix = gmp_cnn(att_matrix)
        ...
        dense_weight = Dense(96, name="dense_weight")
        # att_matrix_sq=attention_trans_layer(dense_weight(coweight_sq))
        ...
        att_matrix = Multi([att_matrix, desc_dropout])
        dense_tq4 = Dense(96, name="dense_tq4")
