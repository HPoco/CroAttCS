...
def run(searcher, analyzer):
        tokenFile = open("./DeepCom_JAVA/train_tokens.txt")
        descFile = open("./DeepCom_JAVA/train_desc.txt")
        similarityToken=open("./DeepCom_JAVA/train_IR_code_tokens.txt","w")
        similarityDesc=open("./DeepCom_JAVA/train_IR_code_desc.txt","w")
...
if __name__ == '__main__':
    ...
    base_dir = "./IndexFiles_DeepCom.index"
